...
export default function HomeCard({ number, heading, subheading, icon, alignm = 'center', numbered }: HomeCardProps) {
    ...
    return (
        <div className={`mx-auto p-6 bg-white rounded-2xl sm:w-[22rem] lg:w-[42.5rem] 3xl:w-[55rem] px-4 pt-4 pb-6 lg:p-6 3xl:p-8 ${alignmentClasses[alignm]}`}>
            {icon && (
